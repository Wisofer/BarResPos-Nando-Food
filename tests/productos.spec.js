...
test.describe("Flujo de Productos (Admin)", () => {
  ...
  test("Debería acceder al catálogo y visualizar la lista de productos", async ({ page }) => {
    ...
    const nuevoProductoBtn = page.locator('button:has-text("Nuevo producto"), button:has-text("Nuevo Producto")');
  ...
  test("Debería abrir el modal de nuevo producto", async ({ page }) => {
    ...
    await page.click('button:has-text("Nuevo producto"), button:has-text("Nuevo Producto")');
